...
def qq_download_by_vid(vid, title, output_dir='.', merge=True, info_only=False, **kwargs):
    ...
    if not info_only:
        download_urls(part_urls, title, ext, total_size, output_dir=output_dir, merge=merge, **kwargs)
...
def qq_download(url, output_dir='.', merge=True, info_only=False, **kwargs):
    ...
    qq_download_by_vid(vid, title, output_dir, merge, info_only, **kwargs)
